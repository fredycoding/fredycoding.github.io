      ...
      <div className=" bg-slate-900 bg-opacity-60 border-y-[0.09rem] border-white my-40">
        <div className='animate__animated animate__backInRight'>
          ...
          <div className='ajustarTarjetas gap-4'>            
            ...
            <CardJobs titulo="Weather App" urlgithub="https://github.com/fredycoding/08_App_Clima_React/tree/master" texto="Weather app made in React, where you get the weather data of your current location and cities by search" url="https://rococo-haupia-55aa2f.netlify.app/" imagen="https://user-images.githubusercontent.com/16197568/190189754-189c3ce8-cd9e-4177-a930-652389014a4c.png" />
